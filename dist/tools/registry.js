...
import { loadRegistry, saveRegistry, addEntry, removeEntry, isValidCode, } from "../lib/registry.js";
export function handleRegistry(input, memoryDir, registryFile) {
    ...
    switch (input.action) {
        case "list": {
            ...
            const lines = [...registry.entries()].map(([code, exp]) => `${code} = ${exp}`);
